...
def test_build_messages():
    ...
    detector2 = GemmaQuestionDetector(client, model="gemma-3", prompt_template="Please check if this is a question.")
    try:
    ...
    detector3 = GemmaQuestionDetector(client, model="gemma-3", prompt_template="Check it carefully.")
    try:
